...
import com.main.config.PaytmDetailsPojo;
...
public class PaytmController {
	...
	public String getResponseRedirect(HttpServletRequest request, Model model) {
		...
		for (Entry<String, String[]> requestParamEntry : mapData.entrySet()) {
			if ("CHECKSUMHASH".equalsIgnoreCase(requestParamEntry.getKey())) {
				paytmChecksum = requestParamEntry.getValue()[0];
			} else {
				parameters.put(requestParamEntry.getKey(), requestParamEntry.getValue()[0]);
			}
		}
		String result;
