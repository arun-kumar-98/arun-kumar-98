...
public class EmployeeServiceImpl {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedWriter writer = new BufferedWriter(new FileWriter(new File("/home/tector/employee.csv")));
		...
		do {
			...
			case 3:
				...
				BufferedWriter writer2 = new BufferedWriter(new FileWriter(new File("/home/tector/employee.csv")));
			...
			// delete by id
			case 4:
				BufferedWriter writer1 = new BufferedWriter(new FileWriter(new File("/home/tector/employee.csv")));
			...
			case 5:
				BufferedReader reader = new BufferedReader(new FileReader(new File("/home/tector/employee.csv")));
				String str;
				int c = 1;
